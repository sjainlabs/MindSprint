...
const MOCK_MAP_SKILLS: Record<number, RITBandSkills> = {
  180: {
    ...
    skills: [
      {
        skillId: 'map-early-numeracy-checkpoint',
        name: 'Count to 10',
      ...
      {
        skillId: 'map-elementary-operations-and-fractions',
  ...
  210: {
    ...
    skills: [
      ...
      {
        skillId: 'conceptual-fraction-equivalence',
  ...
  230: {
    ...
    skills: [
      {
        skillId: 'map-middle-school-analysis',
      ...
      {
        skillId: 'reasoning-proportional-and-statistical-arguments',
  ...
  250: {
    ...
    skills: [
      {
        skillId: 'map-algebra-and-geometry-readiness',
      ...
      {
        skillId: 'map-advanced-math-prep',
